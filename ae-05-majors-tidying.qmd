...
The year is formatted into a character (chr) variable and should be numeric value. This happened as R had read the information as a text.
...
NA occurs when the value inputed into N is 0.
...
statsci |> 
  ...
  mutate(
    degree_type = str_remove(degree_type, "\\)"), 
    degree_type = fct_relevel(degree_type, "BS", "BS2", "AB", "AB2")) |> 
    ggplot(aes(x=year, y=n, color = degree_type)) + geom_point() + geom_path()
...
*I will need to add titles, adjust the x axis into 2 year incrments and change the colors of the points/line and background. In addition, I will need to move the legend to the correct place on the graph*
...
statsci |> 
  ...
  scale_color_manual( 
    values = c("BS" = "cadetblue4",                                                                                 
               "BS2" = "cadetblue3",
               "AB" = "lightgoldenrod4",
               "AB2" = "lightgoldenrod3")) + labs(title = "Graduation Year", x = "Number of Graduating Students", 
                                                  y = "Academic Years 2011-2023", 
                                                  caption = "Source: Office of Duke University Registrar")
  ...
  scale_color_manual( 
    values = c("BS" = "cadetblue4",                                                                                 
               ...
               "AB2" = "lightgoldenrod3")) + labs(title = "Graduation Year", x = "Number of Graduating Students", 
                                                  y = "Academic Years 2011-2023", 
                                                  caption = "Source: Office of Duke University Registrar") +
  theme_minimal() + theme(legend.position = c(0.2, 0.8), legend.background = element_rect(fill = "white", color = "grey"))
